...
| Phase C   | 协作增强   | 🚧  | 版本历史、双人联署、飞书卡片通知与定时推送     |
| Phase D   | AI 与扩展 | 🚧  | 智能总结、AI 辅助编辑、恋爱地图、共同爱好     |
| Phase E   | 可视化趣味  | 🚧  | 恋爱记忆（星图 + 图鉴）、首页完善、立体书、彩蛋   |
...
| 飞书通知卡片    | 📋  | 出站通知改为 interactive card（标题、摘要、跳转按钮）   |
| 通知偏好      | ✅   | 按事件类型开关，`/settings?tab=notifications` |
| 定时推送飞书卡片  | 📋  | Cron 定时投递卡片（日报/周报摘要、纪念日提醒等）           |
| AI 摘要就绪通知 | 📋  | 智能总结完成后触达；可复用飞书卡片通道                   |
| 纪念日提醒     | 📋  | 相识日、纪念日临近提醒；可并入定时卡片推送                 |
...
| 功能      | 状态  | 说明                                                        |
| ------- | --- | --------------------------------------------------------- |
| 聊天助手    | ✅   | 侧栏流式聊天、会话持久化、全局/文章上下文、Tool 检索；见 [ai.md](docs/specs/ai.md) |
...
| 恋爱记忆星图  | 📋  | 回忆可视化、点亮动效；见 [love-memories.md](docs/specs/love-memories.md) |
| 恋爱记忆图鉴  | 📋  | 按类型 / 时间浏览记忆卡片；同上                                       |
| 记忆里程碑   | 📋  | 自动徽章与高亮节点（首信、百天、streak 等）；同上                            |
