...
| Phase C   | 协作增强   | 🚧  | 版本历史、双人联署                  |
| Phase D   | AI 与扩展 | 🚧  | 智能总结、AI 辅助编辑、恋爱地图、共同爱好     |
| Phase E   | 可视化趣味  | 🚧  | 首页完善、记账、立体书、彩蛋             |
...
| -------------- | -------------------------------------------- |
| 功能上线 / 状态变化    | 本文件                                          |
| 空间开通 / 署名 / 邀请 | [space-onboarding.md](docs/specs/space-onboarding.md) |
| AI             | [ai.md](docs/specs/ai.md)                             |
| API Token      | [api-token.md](docs/specs/api-token.md)               |
| 架构 / 表结构       | [ARCHITECTURE.md](docs/ARCHITECTURE.md)         |
