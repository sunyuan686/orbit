...
import { loadFeishuRuntime } from "../feishu/feishu-settings.js";
import {
  getTenantAccessToken,
  sendFeishuTextMessage,
} from "../feishu/feishu-api.js";
import { recordAudit } from "../space/audit.js";
import type { AiRuntimeEnv } from "../ai/ai-model.js";
import { getOtherUserId, getUserById } from "../space/space-authors.js";
...
export async function dispatchNotification(
  ...
  const prefs = parseNotificationPreferences(
    recipientRow?.notificationPreferences
  );
